          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto" style="border-radius: 10px;">
              <div class="card-body px-5 py-5">
                ...
                <img src="{{url('/public/logo/mensani_logo.png')}}" alt="logo" style="height: 44px;width: 157px;" />
                </div>
                <h3 class="card-title text-left mb-3" style="text-align: center;">Therapist Login</h3>
                <form method="POST" action="{{route('therepist_login')}}">
                    @csrf
