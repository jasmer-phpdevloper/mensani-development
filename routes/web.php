...
Route::get('notification',[AdminController::class,'notification'])->name('add_notification');
Route::post('save_notification',[AdminController::class,'save_notification']);
Route::get('view_notification',[AdminController::class,'view_notification'])->name('view_notification');
